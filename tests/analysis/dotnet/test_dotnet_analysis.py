...
from utils.common import extract_zip_to_temp_dir, verify_triggered_rules, get_project_path
...
def test_hello_world_linux_analysis_with_rules(dotnet_analysis_data):
    ...
    custom_rules_path = os.path.join(get_project_path(), 'data', 'yaml', 'dotnet', 'example_rules')
